...
toy_fs = make_toy_data(constraint = "FS", nsamples = 20, ctrl_s = 5, ctrl_n = 100)
str(toy_fs)
head(toy_fs)
 ...
 this_rad = as.integer(toy_fs[i, 3:ncol(toy_fs)])
  ...
  fs_r2[[i]] <- get_stat_list(empirical_rad = this_rad,
                              ...
                              stat = "r2", constraint = get_fs_ct(s, n, nsamples = nsamples, 
                                                                  newsamples = F, oldsamples = constraint_samples[[i]][[1]]))
...
toy_fs <- cbind(toy_fs, fs_r2_quantile, fs_evar_quantile, fs_simp_quantile, fs_skew_quantile, mete_r2_quantile, mete_evar_quantile, mete_simp_quantile, mete_skew_quantile, poilog_expmu,
                poilog_sig)
